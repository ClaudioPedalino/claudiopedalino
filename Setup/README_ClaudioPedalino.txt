#Mentions:
	# To setup db need to run "update-database" command, inside i put the initial script
	# Also postman collection folder called "FillSomeData_Checked" create some 'transactions'
...
# In my work i had no problems (because Windows Enterprise) but im home now and use windows home, so i need to trick docker with this
	https://itnext.io/install-docker-on-windows-10-home-d8e621997c1d
	
SQLServer Image for windows => https://hub.docker.com/r/microsoft/mssql-server-windows-developer/
